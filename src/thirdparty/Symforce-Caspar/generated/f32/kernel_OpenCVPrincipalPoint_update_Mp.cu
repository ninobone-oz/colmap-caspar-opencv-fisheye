...
__global__ void __launch_bounds__(1024, 1) OpenCVPrincipalPointUpdateMpKernel(
    ...
    unsigned int OpenCVPrincipalPoint_Mp_num_alloc,
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteIdx2<1024, float, float, float2>(
        ...
        0 * out_OpenCVPrincipalPoint_Mp_kp1_num_alloc,
        global_thread_idx,
        r0,
        r4);
    WriteIdx2<1024, float, float, float2>(
        out_OpenCVPrincipalPoint_w,
        0 * out_OpenCVPrincipalPoint_w_num_alloc,
        global_thread_idx,
        r0,
        r4);
  };
...
void OpenCVPrincipalPointUpdateMp(
  ...
  OpenCVPrincipalPointUpdateMpKernel<<<n_blocks, 1024>>>(
      ...
      OpenCVPrincipalPoint_Mp,
      OpenCVPrincipalPoint_Mp_num_alloc,
      beta,
      out_OpenCVPrincipalPoint_Mp_kp1,
      out_OpenCVPrincipalPoint_Mp_kp1_num_alloc,
      out_OpenCVPrincipalPoint_w,
      out_OpenCVPrincipalPoint_w_num_alloc,
      problem_size);
}
