...
__global__ void __launch_bounds__(1024, 1)
  ...
  if (global_thread_idx < problem_size) {
    ...
    r38 = r38 * r9;
    r44 = r20 * r44;
    r9 = fmaf(r34, r44, r34 * r38);
    r26 = fmaf(r39, r44, r39 * r38);
    WriteSum4<float, float>((float*)inout_shared, r3, r42, r9, r26);
  };
  ...
  if (global_thread_idx < problem_size) {
    r4 = r6 * r4;
    r5 = r6 * r5;
    r6 = fmaf(r10, r44, r10 * r38);
    r44 = fmaf(r28, r44, r28 * r38);
    WriteSum4<float, float>((float*)inout_shared, r6, r44, r4, r5);
  };
  FlushSumShared<4, float>(out_calib_njtr,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r38 = r39 * r39;
    r38 = fmaf(r38, r11, r38 * r2);
    WriteSum4<float, float>((float*)inout_shared, r5, r44, r6, r38);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    r44 = r28 * r28;
    r44 = fmaf(r11, r44, r2 * r44);
    WriteSum4<float, float>((float*)inout_shared, r6, r44, r35, r35);
  };
  FlushSumShared<4, float>(out_calib_precond_diag,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r26 = r12 * r10;
    r26 = r26 * r4;
    WriteSum4<float, float>((float*)inout_shared, r35, r44, r5, r26);
  };
  ...
  if (global_thread_idx < problem_size) {
    ...
    WriteSum4<float, float>((float*)inout_shared, r36, r26, r38, r29);
  };
  FlushSumShared<4, float>(out_calib_precond_tril,
  ...
  if (global_thread_idx < problem_size) {
    ...
    r34 = r1 * r34;
    r34 = r34 * r0;
    WriteSum4<float, float>((float*)inout_shared, r38, r34, r29, r6);
  };
  FlushSumShared<4, float>(out_calib_precond_tril,
