...
__global__ void __launch_bounds__(1024, 1)
  ...
  SumStore<float>(out_OpenCVCalib_pred_dec_local,
                  (float*)inout_shared,
                  0,
                  global_thread_idx < problem_size,
                  r25);
  SumFlushFinal<float>(
      out_OpenCVCalib_pred_dec_local, out_OpenCVCalib_pred_dec, 1);
}
...
void OpenCVCalibPredDecreaseTimesTwo(
  ...
  OpenCVCalibPredDecreaseTimesTwoKernel<<<n_blocks, 1024>>>(
      OpenCVCalib_step,
      OpenCVCalib_step_num_alloc,
      OpenCVCalib_precond_diag,
      OpenCVCalib_precond_diag_num_alloc,
      diag,
      OpenCVCalib_njtr,
      OpenCVCalib_njtr_num_alloc,
      out_OpenCVCalib_pred_dec,
      problem_size);
}
