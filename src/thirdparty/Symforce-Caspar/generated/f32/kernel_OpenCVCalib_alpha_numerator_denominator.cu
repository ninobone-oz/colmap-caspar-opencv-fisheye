...
__global__ void __launch_bounds__(1024, 1)
  ...
  SumStore<float>(OpenCVCalib_total_ag_local,
                  (float*)inout_shared,
                  0,
  ...
  SumStore<float>(OpenCVCalib_total_ac_local,
                  (float*)inout_shared,
                  0,
                  global_thread_idx < problem_size,
                  r6);
...
void OpenCVCalibAlphaNumeratorDenominator(
  ...
  OpenCVCalibAlphaNumeratorDenominatorKernel<<<n_blocks, 1024>>>(
      OpenCVCalib_p_kp1,
      OpenCVCalib_p_kp1_num_alloc,
      OpenCVCalib_r_k,
      OpenCVCalib_r_k_num_alloc,
      OpenCVCalib_w,
      OpenCVCalib_w_num_alloc,
      OpenCVCalib_total_ag,
      OpenCVCalib_total_ac,
      problem_size);
}
