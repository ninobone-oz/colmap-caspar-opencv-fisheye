...
__global__ void __launch_bounds__(1024, 1)
    OpenCVCalibUpdateRFirstKernel(float* OpenCVCalib_r_k,
                                  unsigned int OpenCVCalib_r_k_num_alloc,
                                  float* OpenCVCalib_w,
                                  unsigned int OpenCVCalib_w_num_alloc,
                                  const float* const negalpha,
                                  float* out_OpenCVCalib_r_kp1,
                                  unsigned int out_OpenCVCalib_r_kp1_num_alloc,
                                  float* const out_OpenCVCalib_r_0_norm2_tot,
                                  float* const out_OpenCVCalib_r_kp1_norm2_tot,
                                  size_t problem_size) {
  ...
  SumStore<float>(out_OpenCVCalib_r_0_norm2_tot_local,
                  (float*)inout_shared,
                  0,
  ...
  SumStore<float>(out_OpenCVCalib_r_kp1_norm2_tot_local,
                  (float*)inout_shared,
                  0,
                  global_thread_idx < problem_size,
                  r7);
  SumFlushFinal<float>(
      out_OpenCVCalib_r_0_norm2_tot_local, out_OpenCVCalib_r_0_norm2_tot, 1);
  SumFlushFinal<float>(out_OpenCVCalib_r_kp1_norm2_tot_local,
                       out_OpenCVCalib_r_kp1_norm2_tot,
                       1);
}

void OpenCVCalibUpdateRFirst(float* OpenCVCalib_r_k,
                             unsigned int OpenCVCalib_r_k_num_alloc,
                             float* OpenCVCalib_w,
                             unsigned int OpenCVCalib_w_num_alloc,
                             const float* const negalpha,
  ...
  OpenCVCalibUpdateRFirstKernel<<<n_blocks, 1024>>>(
      OpenCVCalib_r_k,
      OpenCVCalib_r_k_num_alloc,
      OpenCVCalib_w,
      OpenCVCalib_w_num_alloc,
      negalpha,
      out_OpenCVCalib_r_kp1,
      out_OpenCVCalib_r_kp1_num_alloc,
      out_OpenCVCalib_r_0_norm2_tot,
      out_OpenCVCalib_r_kp1_norm2_tot,
      problem_size);
}
